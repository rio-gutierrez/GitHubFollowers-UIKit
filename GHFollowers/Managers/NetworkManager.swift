...
class NetworkManager {
    ...
    static let shared   = NetworkManager()  // we create the `NetworkManager` as a singleton
...
// ------- This is how we would do the data fetching prior to async-await ----------
...
// ------- And this is how we would do the data fetching prior to async-await and prior to the introduction of the `Result` type ----------
